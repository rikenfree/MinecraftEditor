...
public class PreviewScreenUtil1 : MonoBehaviour
{
	private static PreviewScreenUtil1 _instance;

	private int W;

	private int H;

	public static PreviewScreenUtil1 instance
	{
		get
		{
			if (_instance == null)
			{
				_instance = new GameObject("ScreenUtil").AddComponent<PreviewScreenUtil1>();
