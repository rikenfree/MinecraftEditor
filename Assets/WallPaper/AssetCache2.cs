...
{
    public static class ExpirationModes2
    {
    ...
    public class Asset2
    {
        ...
        static public Asset2 Create(string srcUrl, int expirationDays = ExpirationModes.EXPIRATION_DEFAULT, SpriteMeshType meshType = SpriteMeshType.FullRect, string forceLocalFileName = "M")
        {
            Asset2 a = new Asset2();
            a.srcUrl = srcUrl;
            a.meshType = meshType;
            ...
            {
                expirationDays = Config2.GetInt("assets_expiration_default");
            }
        ...
        private void _AdjustForThumbs()
        {
            ...
            {
                expirationDays = Config2.GetInt("assets_expiration_days_for_thumbs");
            }
        }
    }
    ...
    class SpriteCacheItem2
    {
        public Sprite sprite;
        public int refCnt;
        public SpriteCacheItem2(Sprite sprite, int refCnt)
        {
            this.sprite = sprite;
            this.refCnt = refCnt;
        }
    ...
    public class AssetCache2 : MonoBehaviour
    {
        private static AssetCache2 _instance;
        ...
        public static AssetCache2 Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new GameObject("_AssetCache").AddComponent<AssetCache2>();
        ...
        public Sprite LoadSprite(string key, Sprite placeholder = null)
        {
            ...
            else
            {
                ...
                if (texture != null)
                {
                    ...
                    {
                        //Debug.SendSoftErrorInfo("AssetCache:LoadImage(II)", ErrorReporting.BuildSoftError_ExceptionInfo(e) + "\nerror loading texture from key: " + key);
                        // invalid asset for some reason
                        DeleteAsset(key);
                        flagReloadAssets = true;
                    }
        ...
        public Texture2D LoadImage(string key)
        {
            ...
            if (la != null)
            {
                ...
                else
                {
                    ...
                    if (File.Exists(fileName))
                    {
                        byte[] bb = Utils2.File_ReadAllBytes(fileName, bytebuffer);
                        ...
                        try
                        {
                            ...
                            if ((texture.width == 8) && (texture.height == 8))
                            {
                                ...
                                DeleteAsset(key);
                                AssetCache2.flagReloadAssets = true;
                                return null;
                            }
                        }
                        catch (IOException e)
