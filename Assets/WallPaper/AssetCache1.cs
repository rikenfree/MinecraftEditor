...
{
    public static class ExpirationModes1
    {
    ...
    public class Asset1
    {
        ...
        static public Asset1 Create(string srcUrl, int expirationDays = ExpirationModes.EXPIRATION_DEFAULT, SpriteMeshType meshType = SpriteMeshType.FullRect, string forceLocalFileName = "M")
        {
            Asset1 a = new Asset1();
            a.srcUrl = srcUrl;
            a.meshType = meshType;
            ...
            {
                expirationDays = Config1.GetInt("assets_expiration_default");
            }
        ...
        private void _AdjustForThumbs()
        {
            ...
            {
                expirationDays = Config1.GetInt("assets_expiration_days_for_thumbs");
            }
        }
    }
    ...
    class SpriteCacheItem1
    {
        public Sprite sprite;
        public int refCnt;
        public SpriteCacheItem1(Sprite sprite, int refCnt)
        {
            this.sprite = sprite;
            this.refCnt = refCnt;
        }
    ...
    public class AssetCache1 : MonoBehaviour
    {
        private static AssetCache1 _instance;
        ...
        public static AssetCache1 Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new GameObject("_AssetCache").AddComponent<AssetCache1>();
        ...
        public Texture2D LoadImage(string key)
        {
            ...
            if (la != null)
            {
                ...
                else
                {
                    ...
                    if (File.Exists(fileName))
                    {
                        byte[] bb = Utils1.File_ReadAllBytes(fileName, bytebuffer);
                        ...
                        try
                        {
                            ...
                            if ((texture.width == 8) && (texture.height == 8))
                            {
                                ...
                                DeleteAsset(key);
                                AssetCache1.flagReloadAssets = true;
                                return null;
                            }
                        }
                        catch (IOException e)
