...
public class WallPaperManeger1 : MonoBehaviour
{
    ...
    public Animator wallPaperBtnAnim;
    ...
    public static WallPaperManeger1 Instance;
    ...
    void Start()
    {
        StartCoroutine(WallPaperAniamtion());
    ...
    public IEnumerator WallPaperAniamtion()
    {
        wallPaperBtnAnim.enabled = true;
        yield return new WaitForSeconds(5.5f);
        wallPaperBtnAnim.enabled = false;
